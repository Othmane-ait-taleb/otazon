...
- Source Code    :  https://github.com/basir/next-Otazone
- Demo Website :  https://nextjs-Otazone-final.vercel.app
...
```
$ git clone https://github.com/basir/next-tailwind-Otazone
$ cd next-tailwind-Otazone
$ npm install
$ npm run dev
